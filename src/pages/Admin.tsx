...
const navHeader = { text: 'Health Tracker', href: '/' };
export const navItems: SideNavigationProps['items'] = [
    {
        type: 'section',
        text: 'Views',
        items: [
            { type: 'link', text: 'Physician', href: `/physician` },
            { type: 'link', text: 'Physician Assistant', href: '../physicianassistant' },
            { type: 'link', text: 'Nurse', href: '../nurse' },
            { type: 'link', text: 'Pharmacist', href: '../pharmacist' },
            { type: 'link', text: 'Technician', href: '../technician' },
        ],
    },
    {
        type: 'section',
