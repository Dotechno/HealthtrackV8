    ...
    const {
                ...
                const tabs = [
                    {
                        ...
                        content: (
                            <Details
                    loadHelpPanelContent={loadHelpPanelContent.bind(
                        DetailsView
                    )}
                />
            ),
        ...
        },
        {
            ...
            content: (
                <EmptyTable
                    title="Invalidation"
                    columnDefinitions={INVALIDATIONS_COLUMN_DEFINITIONS as any}
                />
            ),
        },
        {
            ...
            id: 'tags',
            content: (
                <EmptyTable title={'hi mom'} columnDefinitions={[]}/>
            ),
        },
    ];
