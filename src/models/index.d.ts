...
type EagerTemperature = {
  readonly temperature?: number | null;
  readonly type?: TemperatureUnit | keyof typeof TemperatureUnit | null;
}

type LazyTemperature = {
  readonly temperature?: number | null;
  readonly type?: TemperatureUnit | keyof typeof TemperatureUnit | null;
}

export declare type Temperature = LazyLoading extends LazyLoadingDisabled ? EagerTemperature : LazyTemperature

export declare const Temperature: (new (init: ModelInit<Temperature>) => Temperature)
