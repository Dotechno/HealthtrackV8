...
export default function WorkScheduleCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPhysicianID(initialValues.physicianID);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new WorkSchedule(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "WorkScheduleCreateForm")}
      {...rest}
    >
      <ArrayField
