...
export default function MedicalEncounterUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = medicalEncounterRecord
      ...
      : initialValues;
    setEncounterDateTime(cleanValues.encounterDateTime);
    setPractitionerTypeSeen(cleanValues.practitionerTypeSeen);
    setPatientComplaints(cleanValues.patientComplaints);
    setVitalSigns(cleanValues.vitalSigns);
    setPractionerNotes(cleanValues.practionerNotes);
    setLabOrders(cleanValues.labOrders);
    setPharmacyOrders(cleanValues.pharmacyOrders);
    ...
    setRecommendedFollowUp(cleanValues.recommendedFollowUp);
    setDataTimeEncounterSubmitted(cleanValues.dataTimeEncounterSubmitted);
    setEmployeeIDWhoSubmitted(cleanValues.employeeIDWhoSubmitted);
    setErrors({});
  };
