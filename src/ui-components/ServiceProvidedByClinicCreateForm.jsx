...
export default function ServiceProvidedByClinicCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ServiceProvidedByClinic(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ServiceProvidedByClinicCreateForm")}
      {...rest}
    >
      <TextField
        label="Type"
