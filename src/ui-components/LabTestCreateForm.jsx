...
export default function LabTestCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setRangeOfNotNormalResults(initialValues.rangeOfNotNormalResults);
    setLaborderID(initialValues.laborderID);
    setRangeOfNormalResults(initialValues.rangeOfNormalResults);
    setErrors({});
  };
  const validations = {
    typeName: [],
